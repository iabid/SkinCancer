...
if __name__ == "__main__":
    ...
    train_path = "/content/SkinCancer/new_data/train"
    valid_path = "/content/SkinCancer/new_data/valid"

    ## Training
    train_x = sorted(glob(os.path.join(train_path, "image", "*.bmp")))
    train_y = sorted(glob(os.path.join(train_path, "mask", "*.bmp")))

    ## Shuffling
    train_x, train_y = shuffling(train_x, train_y)

    ## Validation
    valid_x = sorted(glob(os.path.join(valid_path, "image", "*.bmp")))
    valid_y = sorted(glob(os.path.join(valid_path, "mask", "*.bmp")))
