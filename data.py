...
def load_data(path, split=0.1):
    ...
    img_path = glob(os.path.join(path, "/content/drive/MyDrive/Ph2DataFolder/TrainingImagesFilesBMP/*"))
    msk_path = glob(os.path.join(path, "/content/drive/MyDrive/Ph2DataFolder/LeisonMAskFiles/*"))
...
def main():
    np.random.seed(42)
    path = "/content/drive/MyDrive/Ph2DataFolder"
